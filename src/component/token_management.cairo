...
pub mod token_management_component {
    ...
    use starkremit_contract::utils::helpers::{assert_not_zero_address, assert_non_zero_amount};
    use super::*;
    ...
    > of ITokenManagement<ComponentState<TContractState>> {
        ...
        fn mint(
            ...
            self.emit(Event::Transfer(Transfer { 
                from: starknet::contract_address_const::<'0x0'>(), 
                to, 
                value: amount 
            }));
        ...
        fn burn(
            ...
            self.emit(Event::Transfer(Transfer { 
                from, 
                to: starknet::contract_address_const::<'0x0'>(), 
                value: amount 
            }));
        ...
        fn set_max_supply(ref self: ComponentState<TContractState>, new_max_supply: u256) -> bool {
            ...
            self.emit(Event::MaxSupplyUpdated(MaxSupplyUpdated { 
                old_max_supply, 
                new_max_supply 
            }));
            true
        ...
        fn transfer_ownership(ref self: ComponentState<TContractState>, new_owner: ContractAddress) -> bool {
            self._assert_only_owner();
