...
use snforge_std::{ContractClassTrait, DeclareResultTrait, declare, start_cheat_caller_address, EventSpyAssertionsTrait, spy_events, start_cheat_block_timestamp};
...
fn test_kyc_status_update() {
    ...
    // Update KYC status
    let success = contract.update_kyc_status(
        user,
        KycStatus::Approved,
        KycLevel::Basic,
        'sample_id_857493',
